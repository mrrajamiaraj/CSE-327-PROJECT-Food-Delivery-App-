...
document.getElementById('addrBtn').onclick = () => location.href = '../permissions/location.html';
...
document.getElementById('cartBadge').textContent = (JSON.parse(localStorage.getItem('cart')||'[]').length)||2;
document.getElementById('cartBtn').onclick = ()=> alert('Open cart');


const CATS = [
  {id:'all',     name:'All',        img:'img/cat-burger.png'},
  {id:'burger',  name:'Burger',     img:'img/cat-burger.png'},
  {id:'pizza',   name:'Pizza',      img:'img/cat-pizza.png'},
  {id:'biriyani',name:'Biriyani',   img:'img/cat-biriyani.png'},
  {id:'desi',    name:'Deshi foods',img:'img/cat-desi.png'},
];
...
const RESTS = [
  {id:1,name:'Rose Garden Restaurant',tags:'Burger • Chicken • Rice • Wings',img:'img/r1.jpg',rating:4.7,fee:'Free',eta:'20 min',cats:['burger']},
  {id:2,name:'Green Bowl',tags:'Salad • Deshi',img:'img/r2.jpg',rating:4.5,fee:'৳29',eta:'18 min',cats:['desi']},
  {id:3,name:'Slice & Sip',tags:'Pizza • Coffee',img:'img/r3.jpg',rating:4.8,fee:'Free',eta:'15 min',cats:['pizza']},
  {id:4,name:'Biryani Point',tags:'Biriyani • Kebab',img:'img/r2.jpg',rating:4.6,fee:'৳35',eta:'25 min',cats:['biriyani']},
];
